...
public class CrearVendedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Crear Vendedor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearVendedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrearVendedores().setVisible(true);
            }
        });
    }
